...
export declare function makeTypedFormData<T extends Record<string, TypedFormDataValue>>(form?: HTMLFormElement): TypedFormData<T>;
//# sourceMappingURL=TypedFormData.d.ts.map
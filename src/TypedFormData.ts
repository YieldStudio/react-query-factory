...
export function makeTypedFormData<T extends Record<string, TypedFormDataValue>>(form?: HTMLFormElement) {
  return new FormData(form) as unknown as TypedFormData<T>;
}
